<template>
	...
	>
		...
		<fv-button
			...
			border-color="transparent"
			:background="
				getBackground(editor.isActive({ textAlign: 'center' }))
			"
			:foreground="
				getForeground(editor.isActive({ textAlign: 'center' }))
			"
		...
		<fv-button
			...
			border-color="transparent"
			:background="
				getBackground(editor.isActive({ textAlign: 'justify' }))
			"
			:foreground="
				getForeground(editor.isActive({ textAlign: 'justify' }))
			"
		...
		<fv-button
			...
			:theme="thisTheme"
			border-color="transparent"
			:background="getBackground(!editor.can().setDetails())"
			:foreground="getForeground(!editor.can().setDetails())"
	...
	methods: {
		...
		insertDrawingBlock() {
			this.editor
				.chain()
				.focus()
				.insertContent(`<drawing-block></drawing-block>`)
				.run();
		},
		toggleDetails() {
