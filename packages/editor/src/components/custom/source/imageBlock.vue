			...
			>
				<div class="power-editor-preview-img-container">
					<fv-img
						...
						:style="{
							scale: previewImg.scalePercent + '%',
							cursor:
								previewImg.scalePercent < 150
									? 'zoom-in'
									: 'zoom-out',
						}"
						@click.capture="
							previewImg.scalePercent < 100
								? setScale($event, 100)
								: previewImg.scalePercent < 150
									? setScale($event, 150)
									: setScale($event, 100)
				...
				>
					...
					<fv-text-box
						:modelValue="previewImg.scalePercent"
						theme="dark"
						underline
...
.power-editor-image-container {
	...
	.show-preview-enter-from,
	.show-preview-leave-to {
		opacity: 0;
	}

	.show-preview-leave-from,
