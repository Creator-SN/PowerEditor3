...
const powerEditorSidebar = [
    ...
    },
    {
        ...
        items: [
            ...
            { text: "图像粘贴与拖放优化", link: "/components/powerEditor/image-paste-drop" },
            { text: "Snapshot Compare", link: "/components/powerEditor/snapshot-compare" },
        ],
    },
    {
        text: "实验室",
        items: [{ text: "Dev 实验室", link: "/components/devC/" }],
    },
];
...
const powerEditorSidebarEn = [
    ...
    },
    {
        ...
        items: [
            ...
            { text: "Image Insertion Optimization", link: "/en/components/powerEditor/image-paste-drop" },
            { text: "Snapshot Compare", link: "/en/components/powerEditor/snapshot-compare" },
        ],
    },
];
...
export default defineConfig({
    ...
    themeConfig: {
        ...
        outline: 3,
        socialLinks: [{ icon: "github", link: "https://github.com/Creator-SN/PowerEditor3" }],
        nav: [
            ...
            {
                text: "关于",
                items: [{ text: "Creator SN", link: "https://github.com/Creator-SN" }],
            },
        ],
        sidebar: {
